        ...
        <div class="modal-content">
          <div class="modal-body details--container">
			...
			<div class="div--text">
				...
				<span class="span--price"><i class="fas fa-money-bill"></i> {{ price }}</span>
				<span class="span--disp"><i class="far fa-calendar-alt"></i> {{ dispProf }} </span>
			</div>
			</div>
			...
			<div id="accordion" class="acordeon--body--specialist">
				<div id="headingOne">
				<h5 class="mb-2">
					<button class="btn pointer" data-toggle="collapse" data-target="#collapseOne" aria-expanded="false" aria-controls="collapseOne">
					Especialidades
				...
				<div>
					<div class="specialist--container">
						<span class="badge badge-primary span--specialist" v-for="spec in specProf" :key="spec.id"> {{ spec.name }} </span>
					</div>
				</div>
				</div>
			</div>
			...
			<div id="accordion" class="acordeon--body--description">
				<div id="headingOne">
				<h5 class="mb-2">
					<button class="btn pointer" data-toggle="collapse" data-target="#collapseTwo" aria-expanded="false" aria-controls="collapseTwo">
					Descripción
					<i class="fas fa-plus"></i>
					<i class="fas fa-minus"></i>
					</button>
