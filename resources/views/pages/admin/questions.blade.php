    ...
    <table class="table table-light">
		...
		<tbody>
			...
			<tr>
				...
				<td>
					<a href="{{ route('admin.edit.questions', $question->id) }}" type="button" class="btn btn-warning">Editar</a>
				</td>
				<td>
					<a href="{{ route('admin.delete.questions', $question->id) }}" class="btn btn-danger delete-confirm">Eliminar</a>
				</td>
			</tr>
			@endforeach
		</tbody>
